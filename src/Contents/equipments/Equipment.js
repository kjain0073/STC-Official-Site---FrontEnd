		...
		return(	
				<div className="Equipment">
			        ...
			        </Helmet>
			        {
			        	...
			        	? <div>
				        	<MobileHeader/>
				        	<div className="mobile-wrapper--equipment flex-direction-column display--flex vertical-align--center horizontal-align--center">
								<div className="equipments__head">
									<div className="equipments__head--main" > <h1> EQUIPMENT </h1></div>
								</div>
								{equipmentList.map((item)=>{
									return(
									<div className="mobile-equipments__row display--flex">
										{item.map((group)=>{
											return(
													<div className="mobile-equipment">
