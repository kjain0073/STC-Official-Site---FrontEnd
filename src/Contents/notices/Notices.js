...
class Notices extends React.Component{
	...
	componentDidMount=()=>{
		...
		var readMore = function(e){
				...
				$('.mobile-content__text.notice--'+notice_no).toggleClass('height--auto')
	...
	render(){
		return(
			<div className="Notices">
				...
				? 	<div>
						<MobileHeader/>
						<div className="mobile-wrapper--notices display--flex vertical-align--center horizontal-align--center flex-direction-column">

						<div className="mobile-notices__element notices__element--head display--flex vertical-align--center">
							<h1> NOTICES </h1>
						</div>
						...
						{noticeList.map((item)=>{
							...
							<div className="mobile-notices__element notice-- display--flex">
								<div className="notice--number h1--small"> 
										
											<div className="mobile-number__text"> {item.id} </div>
										
								</div>
								<div className="notice--content h1--smaller" data-number={"" + item.dataNumber }> 
									<div className={"mobile-content__text notice--" + item.dataNumber}>
										<p>{item.content}</p>
					...
					<div>
						...
						<div className="wrapper--notices display--flex vertical-align--center horizontal-align--center flex-direction-column">
							...
							{noticeList.map((item)=>{
								...
								<div className="notices__element notice-- display--flex">
									<div className="notice--number h1--small"> 
