		...
		return(
				<div className="AllProjects">
			        ...
			        </Helmet>
			        {
			        	...
			        	? <div>
			        	  		<MobileHeader/>
			        	  		<div className="mobile-wrapper--projects display--flex horizontal-align--center flex-direction-column vertical-align--center">
									<div className="mobile-projects__head h2--large">
									...
									<div className="wrapper--project__card display--flex">
												...
												<div className="mobile-project__card">
